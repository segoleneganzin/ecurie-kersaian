...
const WeeklyPlannerModal = ({
  ...
  const editSchedule = () => {
    ...
    // For example, toggle between available and not available
    selectedTimeSlot.available = !selectedTimeSlot.available;
    setSchedule(updatedSchedule);
    // Save the updated schedule if onSave is provided
    if (onSave) {
              ...
              <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                ...
                <div className='mt-2'>
                  <p className='text-sm leading-5 text-gray-500'>
                    Contenu du modal. Vous pouvez personnaliser cela en ajoutant
                    vos propres composants et styles.
                  </p>
                </div>
              </div>
            </div>
