...
const Prices = () => {
  return (
    <div className='p-2 pt-16 lg:p-16 sm:p-8' id='prices'>
      ...
      <h3 className='font-bold text-3xl'>Saison 2023/2024</h3>
      ...
      <div className='py-4'>
        ...
        <p className='italic '>
          Cette année, exceptionnellement, les cours auront lieu du 9 octobre au
          6 juillet. <br />
          Pas de cours durant les vacances scolaires.
        </p>
      </div>
      <table className='bg-white border-2 border-principal-color'>
      ...
      {/* cards */}
      <h4 className='font-bold pt-8 text-2xl'>Cartes</h4>
